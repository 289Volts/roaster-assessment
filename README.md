...
Excellent Care Clinic planner is a Next.js + React application that uses Chakra UI for styling and a small custom theme. The app contains a planner/roster UI and calendar grid components under `src/app/components/Planner`.
